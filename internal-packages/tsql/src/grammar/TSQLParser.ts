...
export class TSQLParser extends Parser {
  ...
  public static readonly RULE_tSQLxChildElement = 63;
  public static readonly RULE_tSQLxTagElement = 64;
  public static readonly RULE_tSQLxTagAttribute = 65;
  ...
  public get ruleNames(): string[] {
    return TSQLParser.ruleNames;
  }

  // @Override
  public get serializedATN(): string {
    return TSQLParser._serializedATN;
  }
  ...
  public program(): ProgramContext {
    ...
    this.enterRule(_localctx, 0, TSQLParser.RULE_program);
    let _la: number;
    try {
          ...
          ((_la & ~0x1f) === 0 &&
            ((1 << _la) &
              ((1 << TSQLParser.ALL) |
                ...
                (1 << TSQLParser.ARRAY) |
                (1 << TSQLParser.AS) |
                (1 << TSQLParser.ASCENDING) |
                (1 << TSQLParser.ASOF) |
                (1 << TSQLParser.BETWEEN) |
                (1 << TSQLParser.BOTH) |
                (1 << TSQLParser.BY) |
                (1 << TSQLParser.CASE) |
                (1 << TSQLParser.CAST) |
                (1 << TSQLParser.COHORT) |
                (1 << TSQLParser.COLLATE) |
                (1 << TSQLParser.CROSS) |
                (1 << TSQLParser.CUBE) |
                (1 << TSQLParser.CURRENT) |
                (1 << TSQLParser.DATE) |
                (1 << TSQLParser.DAY) |
                (1 << TSQLParser.DESC) |
                (1 << TSQLParser.DESCENDING) |
                (1 << TSQLParser.DISTINCT) |
                (1 << TSQLParser.ELSE) |
                (1 << TSQLParser.END) |
                (1 << TSQLParser.EXTRACT) |
                (1 << TSQLParser.FINAL) |
                (1 << TSQLParser.FIRST))) !==
              0) ||
          (((_la - 32) & ~0x1f) === 0 &&
            ((1 << (_la - 32)) &
              ((1 << (TSQLParser.FN - 32)) |
                (1 << (TSQLParser.FOLLOWING - 32)) |
                (1 << (TSQLParser.FOR - 32)) |
                (1 << (TSQLParser.FROM - 32)) |
                (1 << (TSQLParser.FULL - 32)) |
                (1 << (TSQLParser.FUN - 32)) |
                (1 << (TSQLParser.GROUP - 32)) |
                (1 << (TSQLParser.HAVING - 32)) |
                (1 << (TSQLParser.HOUR - 32)) |
                (1 << (TSQLParser.ID - 32)) |
                (1 << (TSQLParser.IF - 32)) |
                (1 << (TSQLParser.ILIKE - 32)) |
                (1 << (TSQLParser.IN - 32)) |
                (1 << (TSQLParser.INF - 32)) |
                (1 << (TSQLParser.INNER - 32)) |
                (1 << (TSQLParser.INTERVAL - 32)) |
                (1 << (TSQLParser.IS - 32)) |
                (1 << (TSQLParser.JOIN - 32)) |
                (1 << (TSQLParser.KEY - 32)) |
                (1 << (TSQLParser.LAST - 32)) |
                (1 << (TSQLParser.LEADING - 32)) |
                (1 << (TSQLParser.LEFT - 32)) |
                (1 << (TSQLParser.LET - 32)) |
                (1 << (TSQLParser.LIKE - 32)) |
                (1 << (TSQLParser.LIMIT - 32)) |
                (1 << (TSQLParser.MINUTE - 32)) |
                (1 << (TSQLParser.MONTH - 32)) |
                (1 << (TSQLParser.NAN_SQL - 32)) |
                (1 << (TSQLParser.NOT - 32)) |
                (1 << (TSQLParser.NULL_SQL - 32)) |
                (1 << (TSQLParser.NULLS - 32)))) !==
              0) ||
          (((_la - 64) & ~0x1f) === 0 &&
            ((1 << (_la - 64)) &
              ((1 << (TSQLParser.OFFSET - 64)) |
                (1 << (TSQLParser.ON - 64)) |
                (1 << (TSQLParser.OR - 64)) |
                (1 << (TSQLParser.ORDER - 64)) |
                (1 << (TSQLParser.OUTER - 64)) |
                (1 << (TSQLParser.OVER - 64)) |
                (1 << (TSQLParser.PARTITION - 64)) |
                (1 << (TSQLParser.PRECEDING - 64)) |
                (1 << (TSQLParser.PREWHERE - 64)) |
                (1 << (TSQLParser.QUARTER - 64)) |
                (1 << (TSQLParser.RANGE - 64)) |
                (1 << (TSQLParser.RETURN - 64)) |
                (1 << (TSQLParser.RIGHT - 64)) |
                (1 << (TSQLParser.ROLLUP - 64)) |
                (1 << (TSQLParser.ROW - 64)) |
                (1 << (TSQLParser.ROWS - 64)) |
                (1 << (TSQLParser.SAMPLE - 64)) |
                (1 << (TSQLParser.SECOND - 64)) |
                (1 << (TSQLParser.SELECT - 64)) |
                (1 << (TSQLParser.SEMI - 64)) |
                (1 << (TSQLParser.SETTINGS - 64)) |
                (1 << (TSQLParser.SUBSTRING - 64)) |
                (1 << (TSQLParser.THEN - 64)) |
                (1 << (TSQLParser.THROW - 64)) |
                (1 << (TSQLParser.TIES - 64)) |
                (1 << (TSQLParser.TIMESTAMP - 64)) |
                (1 << (TSQLParser.TO - 64)) |
                (1 << (TSQLParser.TOP - 64)) |
                (1 << (TSQLParser.TOTALS - 64)) |
                (1 << (TSQLParser.TRAILING - 64)) |
                (1 << (TSQLParser.TRIM - 64)) |
                (1 << (TSQLParser.TRUNCATE - 64)))) !==
              0) ||
          (((_la - 96) & ~0x1f) === 0 &&
            ((1 << (_la - 96)) &
              ((1 << (TSQLParser.TRY - 96)) |
                (1 << (TSQLParser.UNBOUNDED - 96)) |
                (1 << (TSQLParser.UNION - 96)) |
                (1 << (TSQLParser.USING - 96)) |
                (1 << (TSQLParser.WEEK - 96)) |
                (1 << (TSQLParser.WHEN - 96)) |
                (1 << (TSQLParser.WHERE - 96)) |
                (1 << (TSQLParser.WHILE - 96)) |
                (1 << (TSQLParser.WINDOW - 96)) |
                (1 << (TSQLParser.WITH - 96)) |
                (1 << (TSQLParser.YEAR - 96)) |
                (1 << (TSQLParser.IDENTIFIER - 96)) |
                (1 << (TSQLParser.FLOATING_LITERAL - 96)) |
                (1 << (TSQLParser.OCTAL_LITERAL - 96)) |
                (1 << (TSQLParser.DECIMAL_LITERAL - 96)) |
                (1 << (TSQLParser.HEXADECIMAL_LITERAL - 96)) |
                (1 << (TSQLParser.STRING_LITERAL - 96)) |
                (1 << (TSQLParser.ASTERISK - 96)) |
                (1 << (TSQLParser.DASH - 96)) |
                (1 << (TSQLParser.DOT - 96)))) !==
              0) ||
          (((_la - 131) & ~0x1f) === 0 &&
            ((1 << (_la - 131)) &
              ((1 << (TSQLParser.LBRACE - 131)) |
                (1 << (TSQLParser.LBRACKET - 131)) |
                (1 << (TSQLParser.LPAREN - 131)) |
                (1 << (TSQLParser.LT - 131)) |
                (1 << (TSQLParser.PLUS - 131)) |
                (1 << (TSQLParser.QUOTE_SINGLE_TEMPLATE - 131)) |
                (1 << (TSQLParser.SEMICOLON - 131)))) !==
              0)
        ) {
          {
            {
  ...
  public declaration(): DeclarationContext {
    ...
    this.enterRule(_localctx, 2, TSQLParser.RULE_declaration);
    try {
      this.state = 190;
      this._errHandler.sync(this);
      switch (this._input.LA(1)) {
        ...
        case TSQLParser.ALL:
        case TSQLParser.AND:
        case TSQLParser.ANTI:
        case TSQLParser.ANY:
        case TSQLParser.ARRAY:
        case TSQLParser.AS:
        case TSQLParser.ASCENDING:
        case TSQLParser.ASOF:
        case TSQLParser.BETWEEN:
        case TSQLParser.BOTH:
        case TSQLParser.BY:
        case TSQLParser.CASE:
        case TSQLParser.CAST:
        case TSQLParser.COHORT:
        case TSQLParser.COLLATE:
        case TSQLParser.CROSS:
        case TSQLParser.CUBE:
        case TSQLParser.CURRENT:
        case TSQLParser.DATE:
        case TSQLParser.DAY:
        case TSQLParser.DESC:
        case TSQLParser.DESCENDING:
        case TSQLParser.DISTINCT:
        case TSQLParser.ELSE:
        case TSQLParser.END:
        case TSQLParser.EXTRACT:
        case TSQLParser.FINAL:
        ...
        case TSQLParser.FUN:
        case TSQLParser.GROUP:
        case TSQLParser.HAVING:
        case TSQLParser.HOUR:
        case TSQLParser.ID:
        case TSQLParser.IF:
        case TSQLParser.ILIKE:
        case TSQLParser.IN:
        case TSQLParser.INF:
        case TSQLParser.INNER:
        case TSQLParser.INTERVAL:
        case TSQLParser.IS:
        case TSQLParser.JOIN:
        case TSQLParser.KEY:
        case TSQLParser.LAST:
        case TSQLParser.LEADING:
        case TSQLParser.LEFT:
        case TSQLParser.LIKE:
        case TSQLParser.LIMIT:
        case TSQLParser.MINUTE:
        case TSQLParser.MONTH:
        case TSQLParser.NAN_SQL:
        case TSQLParser.NOT:
        case TSQLParser.NULL_SQL:
        case TSQLParser.NULLS:
        case TSQLParser.OFFSET:
        case TSQLParser.ON:
        case TSQLParser.OR:
        case TSQLParser.ORDER:
        case TSQLParser.OUTER:
        case TSQLParser.OVER:
        case TSQLParser.PARTITION:
        case TSQLParser.PRECEDING:
        case TSQLParser.PREWHERE:
        case TSQLParser.QUARTER:
        case TSQLParser.RANGE:
        case TSQLParser.RETURN:
        case TSQLParser.RIGHT:
        case TSQLParser.ROLLUP:
        case TSQLParser.ROW:
        case TSQLParser.ROWS:
        case TSQLParser.SAMPLE:
        case TSQLParser.SECOND:
        case TSQLParser.SELECT:
        case TSQLParser.SEMI:
        case TSQLParser.SETTINGS:
        case TSQLParser.SUBSTRING:
        case TSQLParser.THEN:
        case TSQLParser.THROW:
        case TSQLParser.TIES:
        case TSQLParser.TIMESTAMP:
        case TSQLParser.TO:
        case TSQLParser.TOP:
        case TSQLParser.TOTALS:
        case TSQLParser.TRAILING:
        case TSQLParser.TRIM:
        case TSQLParser.TRUNCATE:
        case TSQLParser.TRY:
        case TSQLParser.UNBOUNDED:
        case TSQLParser.UNION:
        case TSQLParser.USING:
        case TSQLParser.WEEK:
        case TSQLParser.WHEN:
        case TSQLParser.WHERE:
        case TSQLParser.WHILE:
        case TSQLParser.WINDOW:
        case TSQLParser.WITH:
        case TSQLParser.YEAR:
        case TSQLParser.IDENTIFIER:
        case TSQLParser.FLOATING_LITERAL:
        case TSQLParser.OCTAL_LITERAL:
        case TSQLParser.DECIMAL_LITERAL:
        case TSQLParser.HEXADECIMAL_LITERAL:
        case TSQLParser.STRING_LITERAL:
        case TSQLParser.ASTERISK:
        case TSQLParser.DASH:
        case TSQLParser.DOT:
        case TSQLParser.LBRACE:
        case TSQLParser.LBRACKET:
        case TSQLParser.LPAREN:
        case TSQLParser.LT:
        case TSQLParser.PLUS:
        case TSQLParser.QUOTE_SINGLE_TEMPLATE:
        case TSQLParser.SEMICOLON:
  ...
  public expression(): ExpressionContext {
    ...
    this.enterRule(_localctx, 4, TSQLParser.RULE_expression);
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        this.state = 192;
  ...
  public varDecl(): VarDeclContext {
    ...
    this.enterRule(_localctx, 6, TSQLParser.RULE_varDecl);
    let _la: number;
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        this.state = 194;
        this.match(TSQLParser.LET);
        this.state = 195;
        this.identifier();
        this.state = 199;
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        if (_la === TSQLParser.COLON) {
          {
            this.state = 196;
            this.match(TSQLParser.COLON);
            this.state = 197;
            this.match(TSQLParser.EQ_SINGLE);
            this.state = 198;
            this.expression();
          }
        }
  ...
  public identifierList(): IdentifierListContext {
    ...
    this.enterRule(_localctx, 8, TSQLParser.RULE_identifierList);
    let _la: number;
    try {
      let _alt: number;
      this.enterOuterAlt(_localctx, 1);
  ...
  public statement(): StatementContext {
    ...
    this.enterRule(_localctx, 10, TSQLParser.RULE_statement);
    try {
      this.state = 224;
      this._errHandler.sync(this);
  ...
  public returnStmt(): ReturnStmtContext {
    ...
    this.enterRule(_localctx, 12, TSQLParser.RULE_returnStmt);
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        this.state = 226;
        ...
        switch (this.interpreter.adaptivePredict(this._input, 7, this._ctx)) {
          case 1:
            {
              this.state = 230;
              this.match(TSQLParser.SEMICOLON);
            }
            break;
        }
      }
  ...
  public throwStmt(): ThrowStmtContext {
    ...
    this.enterRule(_localctx, 14, TSQLParser.RULE_throwStmt);
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        this.state = 233;
  ...
  public catchBlock(): CatchBlockContext {
    ...
    this.enterRule(_localctx, 16, TSQLParser.RULE_catchBlock);
    let _la: number;
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        if (_la === TSQLParser.LPAREN) {
          {
            this.state = 241;
            this.match(TSQLParser.LPAREN);
            this.state = 242;
  ...
  public tryCatchStmt(): TryCatchStmtContext {
    ...
    this.enterRule(_localctx, 18, TSQLParser.RULE_tryCatchStmt);
    let _la: number;
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        if (_la === TSQLParser.FINALLY) {
          {
            this.state = 261;
            this.match(TSQLParser.FINALLY);
            this.state = 262;
  ...
  public ifStmt(): IfStmtContext {
    ...
    this.enterRule(_localctx, 20, TSQLParser.RULE_ifStmt);
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        this.state = 265;
  ...
  public whileStmt(): WhileStmtContext {
    ...
    this.enterRule(_localctx, 22, TSQLParser.RULE_whileStmt);
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        this.state = 274;
  ...
  public forStmt(): ForStmtContext {
    ...
    this.enterRule(_localctx, 24, TSQLParser.RULE_forStmt);
    let _la: number;
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        ...
        if (
          ...
          (((_la - 33) & ~0x1f) === 0 &&
            ((1 << (_la - 33)) &
              ((1 << (TSQLParser.FOLLOWING - 33)) |
                (1 << (TSQLParser.FOR - 33)) |
                (1 << (TSQLParser.FROM - 33)) |
                (1 << (TSQLParser.FULL - 33)) |
                (1 << (TSQLParser.GROUP - 33)) |
                (1 << (TSQLParser.HAVING - 33)) |
                (1 << (TSQLParser.HOUR - 33)) |
                (1 << (TSQLParser.ID - 33)) |
                (1 << (TSQLParser.IF - 33)) |
                (1 << (TSQLParser.ILIKE - 33)) |
                (1 << (TSQLParser.IN - 33)) |
                (1 << (TSQLParser.INF - 33)) |
                (1 << (TSQLParser.INNER - 33)) |
                (1 << (TSQLParser.INTERVAL - 33)) |
                (1 << (TSQLParser.IS - 33)) |
                (1 << (TSQLParser.JOIN - 33)) |
                (1 << (TSQLParser.KEY - 33)) |
                (1 << (TSQLParser.LAST - 33)) |
                (1 << (TSQLParser.LEADING - 33)) |
                (1 << (TSQLParser.LEFT - 33)) |
                (1 << (TSQLParser.LIKE - 33)) |
                (1 << (TSQLParser.LIMIT - 33)) |
                (1 << (TSQLParser.MINUTE - 33)) |
                (1 << (TSQLParser.MONTH - 33)) |
                (1 << (TSQLParser.NAN_SQL - 33)) |
                (1 << (TSQLParser.NOT - 33)) |
                (1 << (TSQLParser.NULL_SQL - 33)) |
                (1 << (TSQLParser.NULLS - 33)) |
                (1 << (TSQLParser.OFFSET - 33)))) !==
              0) ||
          (((_la - 65) & ~0x1f) === 0 &&
            ((1 << (_la - 65)) &
              ((1 << (TSQLParser.ON - 65)) |
                (1 << (TSQLParser.OR - 65)) |
                (1 << (TSQLParser.ORDER - 65)) |
                (1 << (TSQLParser.OUTER - 65)) |
                (1 << (TSQLParser.OVER - 65)) |
                (1 << (TSQLParser.PARTITION - 65)) |
                (1 << (TSQLParser.PRECEDING - 65)) |
                (1 << (TSQLParser.PREWHERE - 65)) |
                (1 << (TSQLParser.QUARTER - 65)) |
                (1 << (TSQLParser.RANGE - 65)) |
                (1 << (TSQLParser.RETURN - 65)) |
                (1 << (TSQLParser.RIGHT - 65)) |
                (1 << (TSQLParser.ROLLUP - 65)) |
                (1 << (TSQLParser.ROW - 65)) |
                (1 << (TSQLParser.ROWS - 65)) |
                (1 << (TSQLParser.SAMPLE - 65)) |
                (1 << (TSQLParser.SECOND - 65)) |
                (1 << (TSQLParser.SELECT - 65)) |
                (1 << (TSQLParser.SEMI - 65)) |
                (1 << (TSQLParser.SETTINGS - 65)) |
                (1 << (TSQLParser.SUBSTRING - 65)) |
                (1 << (TSQLParser.THEN - 65)) |
                (1 << (TSQLParser.TIES - 65)) |
                (1 << (TSQLParser.TIMESTAMP - 65)) |
                (1 << (TSQLParser.TO - 65)) |
                (1 << (TSQLParser.TOP - 65)) |
                (1 << (TSQLParser.TOTALS - 65)) |
                (1 << (TSQLParser.TRAILING - 65)) |
                (1 << (TSQLParser.TRIM - 65)) |
                (1 << (TSQLParser.TRUNCATE - 65)))) !==
              0) ||
          (((_la - 97) & ~0x1f) === 0 &&
            ((1 << (_la - 97)) &
              ((1 << (TSQLParser.UNBOUNDED - 97)) |
                (1 << (TSQLParser.UNION - 97)) |
                (1 << (TSQLParser.USING - 97)) |
                (1 << (TSQLParser.WEEK - 97)) |
                (1 << (TSQLParser.WHEN - 97)) |
                (1 << (TSQLParser.WHERE - 97)) |
                (1 << (TSQLParser.WINDOW - 97)) |
                (1 << (TSQLParser.WITH - 97)) |
                (1 << (TSQLParser.YEAR - 97)) |
                (1 << (TSQLParser.IDENTIFIER - 97)) |
                (1 << (TSQLParser.FLOATING_LITERAL - 97)) |
                (1 << (TSQLParser.OCTAL_LITERAL - 97)) |
                (1 << (TSQLParser.DECIMAL_LITERAL - 97)) |
                (1 << (TSQLParser.HEXADECIMAL_LITERAL - 97)) |
                (1 << (TSQLParser.STRING_LITERAL - 97)) |
                (1 << (TSQLParser.ASTERISK - 97)) |
                (1 << (TSQLParser.DASH - 97)) |
                (1 << (TSQLParser.DOT - 97)))) !==
              0) ||
          (((_la - 131) & ~0x1f) === 0 &&
            ((1 << (_la - 131)) &
  ...
  public forInStmt(): ForInStmtContext {
    ...
    this.enterRule(_localctx, 26, TSQLParser.RULE_forInStmt);
    let _la: number;
    try {
      this.enterOuterAlt(_localctx, 1);
      {
  ...
  public funcStmt(): FuncStmtContext {
    ...
    this.enterRule(_localctx, 28, TSQLParser.RULE_funcStmt);
    let _la: number;
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        this.state = 319;
        _la = this._input.LA(1);
        if (!(_la === TSQLParser.FN || _la === TSQLParser.FUN)) {
  ...
  public varAssignment(): VarAssignmentContext {
    ...
    this.enterRule(_localctx, 30, TSQLParser.RULE_varAssignment);
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        this.state = 328;
  ...
  public exprStmt(): ExprStmtContext {
    ...
    this.enterRule(_localctx, 32, TSQLParser.RULE_exprStmt);
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        this.state = 333;
  ...
  public emptyStmt(): EmptyStmtContext {
    ...
    this.enterRule(_localctx, 34, TSQLParser.RULE_emptyStmt);
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        this.state = 337;
  ...
  public block(): BlockContext {
    ...
    this.enterRule(_localctx, 36, TSQLParser.RULE_block);
    let _la: number;
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        this.state = 339;
        this.match(TSQLParser.LBRACE);
        this.state = 343;
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        while (
  ...
  public kvPair(): KvPairContext {
    ...
    this.enterRule(_localctx, 38, TSQLParser.RULE_kvPair);
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        this.state = 348;
  ...
  public kvPairList(): KvPairListContext {
    ...
    this.enterRule(_localctx, 40, TSQLParser.RULE_kvPairList);
    let _la: number;
    try {
      let _alt: number;
      this.enterOuterAlt(_localctx, 1);
  ...
  public select(): SelectContext {
    ...
    this.enterRule(_localctx, 42, TSQLParser.RULE_select);
    let _la: number;
    try {
      this.enterOuterAlt(_localctx, 1);
      {
  ...
  public selectStmtWithParens(): SelectStmtWithParensContext {
    ...
    this.enterRule(_localctx, 44, TSQLParser.RULE_selectStmtWithParens);
    try {
      this.state = 379;
      this._errHandler.sync(this);
      switch (this._input.LA(1)) {
  ...
  public subsequentSelectSetClause(): SubsequentSelectSetClauseContext {
    let _localctx: SubsequentSelectSetClauseContext = new SubsequentSelectSetClauseContext(
      this._ctx,
      this.state
    );
    this.enterRule(_localctx, 46, TSQLParser.RULE_subsequentSelectSetClause);
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        this.state = 389;
  ...
  public selectSetStmt(): SelectSetStmtContext {
    ...
    this.enterRule(_localctx, 48, TSQLParser.RULE_selectSetStmt);
    let _la: number;
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        ...
        _la = this._input.LA(1);
        while (
          _la === TSQLParser.EXCEPT ||
          _la === TSQLParser.INTERSECT ||
          _la === TSQLParser.UNION
        ) {
          {
            {
              this.state = 394;
  ...
  public selectStmt(): SelectStmtContext {
    ...
    this.enterRule(_localctx, 50, TSQLParser.RULE_selectStmt);
    let _la: number;
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        if (_la === TSQLParser.ARRAY || _la === TSQLParser.INNER || _la === TSQLParser.LEFT) {
          {
            this.state = 414;
  ...
  public withClause(): WithClauseContext {
    ...
    this.enterRule(_localctx, 52, TSQLParser.RULE_withClause);
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        this.state = 453;
  ...
  public topClause(): TopClauseContext {
    ...
    this.enterRule(_localctx, 54, TSQLParser.RULE_topClause);
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        this.state = 456;
        ...
        this.state = 457;
        this.match(TSQLParser.DECIMAL_LITERAL);
        this.state = 460;
        this._errHandler.sync(this);
  ...
  public fromClause(): FromClauseContext {
    ...
    this.enterRule(_localctx, 56, TSQLParser.RULE_fromClause);
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        this.state = 462;
  ...
  public arrayJoinClause(): ArrayJoinClauseContext {
    ...
    this.enterRule(_localctx, 58, TSQLParser.RULE_arrayJoinClause);
    let _la: number;
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        if (_la === TSQLParser.INNER || _la === TSQLParser.LEFT) {
          {
            this.state = 465;
            _la = this._input.LA(1);
            if (!(_la === TSQLParser.INNER || _la === TSQLParser.LEFT)) {
  ...
  public windowClause(): WindowClauseContext {
    ...
    this.enterRule(_localctx, 60, TSQLParser.RULE_windowClause);
    let _la: number;
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        this.state = 472;
        this.match(TSQLParser.WINDOW);
        this.state = 473;
        this.identifier();
        this.state = 474;
  ...
  public prewhereClause(): PrewhereClauseContext {
    ...
    this.enterRule(_localctx, 62, TSQLParser.RULE_prewhereClause);
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        this.state = 490;
        this.match(TSQLParser.PREWHERE);
        this.state = 491;
        this.columnExpr(0);
      }
    } catch (re) {
  ...
  public whereClause(): WhereClauseContext {
    ...
    this.enterRule(_localctx, 64, TSQLParser.RULE_whereClause);
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        this.state = 493;
  ...
  public groupByClause(): GroupByClauseContext {
    ...
    this.enterRule(_localctx, 66, TSQLParser.RULE_groupByClause);
    let _la: number;
    try {
      this.enterOuterAlt(_localctx, 1);
      {
  ...
  public havingClause(): HavingClauseContext {
    ...
    this.enterRule(_localctx, 68, TSQLParser.RULE_havingClause);
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        this.state = 506;
  ...
  public orderByClause(): OrderByClauseContext {
    ...
    this.enterRule(_localctx, 70, TSQLParser.RULE_orderByClause);
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        this.state = 509;
  ...
  public projectionOrderByClause(): ProjectionOrderByClauseContext {
    let _localctx: ProjectionOrderByClauseContext = new ProjectionOrderByClauseContext(
      this._ctx,
      this.state
    );
    this.enterRule(_localctx, 72, TSQLParser.RULE_projectionOrderByClause);
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        this.state = 513;
  ...
  public limitByClause(): LimitByClauseContext {
    ...
    this.enterRule(_localctx, 74, TSQLParser.RULE_limitByClause);
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        this.state = 517;
        this.match(TSQLParser.LIMIT);
        this.state = 518;
        this.limitExpr();
        this.state = 519;
        this.match(TSQLParser.BY);
  ...
  public limitAndOffsetClause(): LimitAndOffsetClauseContext {
    let _localctx: LimitAndOffsetClauseContext = new LimitAndOffsetClauseContext(
      this._ctx,
      this.state
    );
    this.enterRule(_localctx, 76, TSQLParser.RULE_limitAndOffsetClause);
    let _la: number;
    try {
      this.state = 541;
      this._errHandler.sync(this);
  ...
  public offsetOnlyClause(): OffsetOnlyClauseContext {
    ...
    this.enterRule(_localctx, 78, TSQLParser.RULE_offsetOnlyClause);
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        this.state = 543;
  ...
  public settingsClause(): SettingsClauseContext {
    ...
    this.enterRule(_localctx, 80, TSQLParser.RULE_settingsClause);
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        this.state = 546;
        this.match(TSQLParser.SETTINGS);
        this.state = 547;
  ...
  public joinExpr(_p?: number): JoinExprContext {
    ...
    this.enterRecursionRule(_localctx, 82, TSQLParser.RULE_joinExpr, _p);
    let _la: number;
    try {
      let _alt: number;
      this.enterOuterAlt(_localctx, 1);
          ...
          if (_alt === 1) {
            ...
            _prevctx = _localctx;
            {
              ...
              switch (this.interpreter.adaptivePredict(this._input, 60, this._ctx)) {
                case 1:
                  {
                    _localctx = new JoinExprCrossOpContext(
                      new JoinExprContext(_parentctx, _parentState)
                    );
                    this.pushNewRecursionContext(_localctx, _startState, TSQLParser.RULE_joinExpr);
                    this.state = 563;
                ...
                case 2:
                  {
                    _localctx = new JoinExprOpContext(
                      new JoinExprContext(_parentctx, _parentState)
                    );
                    this.pushNewRecursionContext(_localctx, _startState, TSQLParser.RULE_joinExpr);
                    this.state = 567;
                    ...
                    if (
                      ...
                      (((_la - 36) & ~0x1f) === 0 &&
                        ((1 << (_la - 36)) &
                          ((1 << (TSQLParser.FULL - 36)) |
                            (1 << (TSQLParser.INNER - 36)) |
                            (1 << (TSQLParser.LEFT - 36)))) !==
                          0) ||
                      _la === TSQLParser.RIGHT ||
                      _la === TSQLParser.SEMI
                    ) {
                      {
                        this.state = 568;
  ...
  public joinOp(): JoinOpContext {
    ...
    this.enterRule(_localctx, 84, TSQLParser.RULE_joinOp);
    let _la: number;
    try {
      this.state = 623;
      this._errHandler.sync(this);
              ...
              case 1:
                {
                  ...
                  if (
                    (_la & ~0x1f) === 0 &&
                    ((1 << _la) &
                      ((1 << TSQLParser.ALL) | (1 << TSQLParser.ANY) | (1 << TSQLParser.ASOF))) !==
                      0
                  ) {
                    {
                      this.state = 580;
              ...
              case 1:
                {
                  ...
                  this.state = 594;
                  _la = this._input.LA(1);
                  if (!(_la === TSQLParser.LEFT || _la === TSQLParser.RIGHT)) {
                    this._errHandler.recoverInline(this);
                  } else {
                    if (this._input.LA(1) === Token.EOF) {
                      this.matchedEOF = true;
              ...
              case 1:
                {
                  ...
                  this._errHandler.sync(this);
                  _la = this._input.LA(1);
                  if (_la === TSQLParser.ALL || _la === TSQLParser.ANY) {
                    {
                      this.state = 607;
                      _la = this._input.LA(1);
                      if (!(_la === TSQLParser.ALL || _la === TSQLParser.ANY)) {
  ...
  public joinOpCross(): JoinOpCrossContext {
    ...
    this.enterRule(_localctx, 86, TSQLParser.RULE_joinOpCross);
    try {
      this.state = 628;
      this._errHandler.sync(this);
      switch (this._input.LA(1)) {
  ...
  public joinConstraintClause(): JoinConstraintClauseContext {
    let _localctx: JoinConstraintClauseContext = new JoinConstraintClauseContext(
      this._ctx,
      this.state
    );
    this.enterRule(_localctx, 88, TSQLParser.RULE_joinConstraintClause);
    try {
      this.state = 639;
      this._errHandler.sync(this);
  ...
  public sampleClause(): SampleClauseContext {
    ...
    this.enterRule(_localctx, 90, TSQLParser.RULE_sampleClause);
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        this.state = 641;
  ...
  public limitExpr(): LimitExprContext {
    ...
    this.enterRule(_localctx, 92, TSQLParser.RULE_limitExpr);
    let _la: number;
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        if (_la === TSQLParser.OFFSET || _la === TSQLParser.COMMA) {
          {
            this.state = 648;
            _la = this._input.LA(1);
            if (!(_la === TSQLParser.OFFSET || _la === TSQLParser.COMMA)) {
  ...
  public orderExprList(): OrderExprListContext {
    ...
    this.enterRule(_localctx, 94, TSQLParser.RULE_orderExprList);
    let _la: number;
    try {
      this.enterOuterAlt(_localctx, 1);
      {
  ...
  public orderExpr(): OrderExprContext {
    ...
    this.enterRule(_localctx, 96, TSQLParser.RULE_orderExpr);
    let _la: number;
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        if (_la === TSQLParser.NULLS) {
          {
            this.state = 664;
            this.match(TSQLParser.NULLS);
            this.state = 665;
            _la = this._input.LA(1);
            if (!(_la === TSQLParser.FIRST || _la === TSQLParser.LAST)) {
              this._errHandler.recoverInline(this);
            } else {
              if (this._input.LA(1) === Token.EOF) {
                this.matchedEOF = true;
        ...
        if (_la === TSQLParser.COLLATE) {
          {
            ...
            this.state = 669;
            this.match(TSQLParser.STRING_LITERAL);
          }
        }
      }
    } catch (re) {
  ...
  public ratioExpr(): RatioExprContext {
    ...
    this.enterRule(_localctx, 98, TSQLParser.RULE_ratioExpr);
    try {
      this.state = 678;
      this._errHandler.sync(this);
      switch (this._input.LA(1)) {
  ...
  public settingExprList(): SettingExprListContext {
    ...
    this.enterRule(_localctx, 100, TSQLParser.RULE_settingExprList);
    let _la: number;
    try {
      this.enterOuterAlt(_localctx, 1);
      {
  ...
  public settingExpr(): SettingExprContext {
    ...
    this.enterRule(_localctx, 102, TSQLParser.RULE_settingExpr);
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        this.state = 688;
  ...
  public windowExpr(): WindowExprContext {
    ...
    this.enterRule(_localctx, 104, TSQLParser.RULE_windowExpr);
    let _la: number;
    try {
      this.enterOuterAlt(_localctx, 1);
      {
  ...
  public winPartitionByClause(): WinPartitionByClauseContext {
    let _localctx: WinPartitionByClauseContext = new WinPartitionByClauseContext(
      this._ctx,
      this.state
    );
    this.enterRule(_localctx, 106, TSQLParser.RULE_winPartitionByClause);
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        this.state = 701;
  ...
  public winOrderByClause(): WinOrderByClauseContext {
    ...
    this.enterRule(_localctx, 108, TSQLParser.RULE_winOrderByClause);
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        this.state = 705;
  ...
  public winFrameClause(): WinFrameClauseContext {
    ...
    this.enterRule(_localctx, 110, TSQLParser.RULE_winFrameClause);
    let _la: number;
    try {
      this.enterOuterAlt(_localctx, 1);
      {
  ...
  public winFrameExtend(): WinFrameExtendContext {
    ...
    this.enterRule(_localctx, 112, TSQLParser.RULE_winFrameExtend);
    try {
      this.state = 718;
      this._errHandler.sync(this);
      switch (this._input.LA(1)) {
  ...
  public winFrameBound(): WinFrameBoundContext {
    ...
    this.enterRule(_localctx, 114, TSQLParser.RULE_winFrameBound);
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        this.state = 732;
  ...
  public expr(): ExprContext {
    ...
    this.enterRule(_localctx, 116, TSQLParser.RULE_expr);
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        this.state = 734;
  ...
  public columnTypeExpr(): ColumnTypeExprContext {
    ...
    this.enterRule(_localctx, 118, TSQLParser.RULE_columnTypeExpr);
    let _la: number;
    try {
      let _alt: number;
      this.state = 793;
  ...
  public columnExprList(): ColumnExprListContext {
    ...
    this.enterRule(_localctx, 120, TSQLParser.RULE_columnExprList);
    try {
      let _alt: number;
      this.enterOuterAlt(_localctx, 1);
      {
  ...
  public columnExpr(_p?: number): ColumnExprContext {
    ...
    this.enterRecursionRule(_localctx, 122, TSQLParser.RULE_columnExpr, _p);
    let _la: number;
    try {
      let _alt: number;
      this.enterOuterAlt(_localctx, 1);
          ...
          case 4:
            {
              ...
              _prevctx = _localctx;
              this.state = 835;
              this.match(TSQLParser.INTERVAL);
              this.state = 836;
              this.match(TSQLParser.STRING_LITERAL);
            }
            break;
          ...
          case 6:
            {
              ...
              _prevctx = _localctx;
              this.state = 841;
              this.match(TSQLParser.SUBSTRING);
              this.state = 842;
              this.match(TSQLParser.LPAREN);
              this.state = 843;
              this.columnExpr(0);
          ...
          case 8:
            {
              ...
              if (
                !(
                  _la === TSQLParser.BOTH ||
                  _la === TSQLParser.LEADING ||
                  _la === TSQLParser.TRAILING
                )
              ) {
                this._errHandler.recoverInline(this);
              } else {
          ...
          case 9:
            {
              ...
              this.identifier();
              {
                ...
                if (
                  ...
                  {
                    this.state = 864;
                    (_localctx as ColumnExprWinFunctionContext)._columnExprs =
                      this.columnExprList();
                  }
                }
              ...
              if (_la === TSQLParser.LPAREN) {
                {
                  ...
                  if (
                    ...
                    {
                      this.state = 873;
                      (_localctx as ColumnExprWinFunctionContext)._columnArgList =
                        this.columnExprList();
                    }
                  }
          ...
          case 10:
            {
              ...
              this.identifier();
              {
                ...
                if (
                  ...
                  {
                    this.state = 886;
                    (_localctx as ColumnExprWinFunctionTargetContext)._columnExprs =
                      this.columnExprList();
                  }
                }
              ...
              if (_la === TSQLParser.LPAREN) {
                {
                  ...
                  if (
                    ...
                    {
                      this.state = 895;
                      (_localctx as ColumnExprWinFunctionTargetContext)._columnArgList =
                        this.columnExprList();
                    }
                  }
                ...
                case 1:
                  {
                    ...
                    if (
                      ...
                      {
                        this.state = 906;
                        (_localctx as ColumnExprFunctionContext)._columnExprs =
                          this.columnExprList();
                      }
                    }
          ...
          case 17:
            {
              ...
              this.state = 933;
              this.match(TSQLParser.ASTERISK);
            }
            break;
          ...
          case 21:
            {
              ...
              _prevctx = _localctx;
              this.state = 946;
              this.match(TSQLParser.LBRACKET);
              this.state = 948;
              this._errHandler.sync(this);
              _la = this._input.LA(1);
              if (
              ...
              this.state = 950;
              this.match(TSQLParser.RBRACKET);
            }
            break;
          ...
          if (_alt === 1) {
            ...
            _prevctx = _localctx;
            {
              ...
              switch (this.interpreter.adaptivePredict(this._input, 132, this._ctx)) {
                case 1:
                  {
                    _localctx = new ColumnExprPrecedence1Context(
                      new ColumnExprContext(_parentctx, _parentState)
                    );
                    (_localctx as ColumnExprPrecedence1Context)._left = _prevctx;
                    this.pushNewRecursionContext(
                      _localctx,
                      _startState,
                      TSQLParser.RULE_columnExpr
                    );
                    this.state = 960;
                    ...
                    switch (this._input.LA(1)) {
                      case TSQLParser.ASTERISK:
                        {
                          this.state = 961;
                          (_localctx as ColumnExprPrecedence1Context)._operator = this.match(
                            TSQLParser.ASTERISK
                          );
                        }
                        break;
                      case TSQLParser.SLASH:
                        {
                          this.state = 962;
                          (_localctx as ColumnExprPrecedence1Context)._operator = this.match(
                            TSQLParser.SLASH
                ...
                case 2:
                  {
                    _localctx = new ColumnExprPrecedence2Context(
                      new ColumnExprContext(_parentctx, _parentState)
                    );
                    ...
                    switch (this._input.LA(1)) {
                      case TSQLParser.PLUS:
                        {
                          this.state = 968;
                          (_localctx as ColumnExprPrecedence2Context)._operator = this.match(
                            TSQLParser.PLUS
                          );
                        }
                        break;
                ...
                case 3:
                  {
                    _localctx = new ColumnExprPrecedence3Context(
                      new ColumnExprContext(_parentctx, _parentState)
                    );
                    ...
                    switch (this.interpreter.adaptivePredict(this._input, 127, this._ctx)) {
                      case 1:
                        {
                          this.state = 975;
                          (_localctx as ColumnExprPrecedence3Context)._operator = this.match(
                            TSQLParser.EQ_DOUBLE
                          );
                        }
                        break;
                      ...
                      case 9:
                        {
                          ...
                          this.state = 992;
                          _la = this._input.LA(1);
                          if (!(_la === TSQLParser.ILIKE || _la === TSQLParser.LIKE)) {
                            this._errHandler.recoverInline(this);
                          } else {
                            if (this._input.LA(1) === Token.EOF) {
                              this.matchedEOF = true;
                ...
                case 4:
                  {
                    _localctx = new ColumnExprNullishContext(
                      new ColumnExprContext(_parentctx, _parentState)
                    );
                    this.pushNewRecursionContext(
                      _localctx,
                ...
                case 5:
                  {
                    _localctx = new ColumnExprAndContext(
                      new ColumnExprContext(_parentctx, _parentState)
                    );
                    this.pushNewRecursionContext(
                      _localctx,
                ...
                case 6:
                  {
                    _localctx = new ColumnExprOrContext(
                      new ColumnExprContext(_parentctx, _parentState)
                    );
                    this.pushNewRecursionContext(
                      _localctx,
                ...
                case 7:
                  {
                    _localctx = new ColumnExprBetweenContext(
                      new ColumnExprContext(_parentctx, _parentState)
                    );
                    this.pushNewRecursionContext(
                      _localctx,
                ...
                case 8:
                  {
                    _localctx = new ColumnExprTernaryOpContext(
                      new ColumnExprContext(_parentctx, _parentState)
                    );
                    this.pushNewRecursionContext(
                      _localctx,
                ...
                case 9:
                  {
                    _localctx = new ColumnExprCallSelectContext(
                      new ColumnExprContext(_parentctx, _parentState)
                    );
                    this.pushNewRecursionContext(
                      _localctx,
                ...
                case 10:
                  {
                    _localctx = new ColumnExprCallContext(
                      new ColumnExprContext(_parentctx, _parentState)
                    );
                    this.pushNewRecursionContext(
                      _localctx,
                ...
                case 11:
                  {
                    _localctx = new ColumnExprArrayAccessContext(
                      new ColumnExprContext(_parentctx, _parentState)
                    );
                    this.pushNewRecursionContext(
                      _localctx,
                ...
                case 12:
                  {
                    _localctx = new ColumnExprTupleAccessContext(
                      new ColumnExprContext(_parentctx, _parentState)
                    );
                    this.pushNewRecursionContext(
                      _localctx,
                ...
                case 13:
                  {
                    _localctx = new ColumnExprPropertyAccessContext(
                      new ColumnExprContext(_parentctx, _parentState)
                    );
                    this.pushNewRecursionContext(
                      _localctx,
                ...
                case 14:
                  {
                    _localctx = new ColumnExprNullArrayAccessContext(
                      new ColumnExprContext(_parentctx, _parentState)
                    );
                    this.pushNewRecursionContext(
                      _localctx,
                    ...
                    this.state = 1049;
                    this.match(TSQLParser.NULL_PROPERTY);
                    this.state = 1050;
                    this.match(TSQLParser.LBRACKET);
                    this.state = 1051;
                    this.columnExpr(0);
                ...
                case 15:
                  {
                    _localctx = new ColumnExprNullTupleAccessContext(
                      new ColumnExprContext(_parentctx, _parentState)
                    );
                    this.pushNewRecursionContext(
                      _localctx,
                ...
                case 16:
                  {
                    _localctx = new ColumnExprNullPropertyAccessContext(
                      new ColumnExprContext(_parentctx, _parentState)
                    );
                    this.pushNewRecursionContext(
                      _localctx,
                ...
                case 17:
                  {
                    _localctx = new ColumnExprIsNullContext(
                      new ColumnExprContext(_parentctx, _parentState)
                    );
                    this.pushNewRecursionContext(
                      _localctx,
                    ...
                    this.state = 1065;
                    this.match(TSQLParser.NULL_SQL);
                  }
                  break;

                case 18:
                  {
                    _localctx = new ColumnExprAliasContext(
                      new ColumnExprContext(_parentctx, _parentState)
                    );
                    this.pushNewRecursionContext(
                      _localctx,
  ...
  public columnLambdaExpr(): ColumnLambdaExprContext {
    ...
    this.enterRule(_localctx, 124, TSQLParser.RULE_columnLambdaExpr);
    let _la: number;
    try {
      let _alt: number;
      this.enterOuterAlt(_localctx, 1);
  ...
  // @RuleVersion(0)
  public tSQLxChildElement(): TSQLxChildElementContext {
    let _localctx: TSQLxChildElementContext = new TSQLxChildElementContext(this._ctx, this.state);
    this.enterRule(_localctx, 126, TSQLParser.RULE_tSQLxChildElement);
    try {
      this.state = 1118;
      this._errHandler.sync(this);
      switch (this._input.LA(1)) {
        case TSQLParser.LT:
          ...
          break;
        case TSQLParser.TSQLX_TEXT_TEXT:
          this.enterOuterAlt(_localctx, 2);
          {
            this.state = 1113;
            this.match(TSQLParser.TSQLX_TEXT_TEXT);
          }
          break;
        case TSQLParser.LBRACE:
          this.enterOuterAlt(_localctx, 3);
  ...
  // @RuleVersion(0)
  public tSQLxTagElement(): TSQLxTagElementContext {
    let _localctx: TSQLxTagElementContext = new TSQLxTagElementContext(this._ctx, this.state);
    this.enterRule(_localctx, 128, TSQLParser.RULE_tSQLxTagElement);
    let _la: number;
    try {
      this.state = 1149;
      this._errHandler.sync(this);
      switch (this.interpreter.adaptivePredict(this._input, 144, this._ctx)) {
        case 1:
          this.enterOuterAlt(_localctx, 1);
          {
            ...
            this.state = 1128;
            this.match(TSQLParser.SLASH_GT);
          }
          break;
        ...
        case 2:
          this.enterOuterAlt(_localctx, 2);
          {
            ...
            this.state = 1138;
            this.match(TSQLParser.GT);
            this.state = 1142;
            this._errHandler.sync(this);
            _la = this._input.LA(1);
            while (
              _la === TSQLParser.LBRACE ||
              _la === TSQLParser.LT ||
              _la === TSQLParser.TSQLX_TEXT_TEXT
            ) {
              {
                {
                  this.state = 1139;
                  this.tSQLxChildElement();
                }
              }
              this.state = 1144;
              this._errHandler.sync(this);
            ...
            this.state = 1145;
            this.match(TSQLParser.LT_SLASH);
            this.state = 1146;
            this.identifier();
            this.state = 1147;
            this.match(TSQLParser.GT);
  ...
  // @RuleVersion(0)
  public tSQLxTagAttribute(): TSQLxTagAttributeContext {
    let _localctx: TSQLxTagAttributeContext = new TSQLxTagAttributeContext(this._ctx, this.state);
    this.enterRule(_localctx, 130, TSQLParser.RULE_tSQLxTagAttribute);
    try {
      this.state = 1162;
      this._errHandler.sync(this);
  ...
  public withExprList(): WithExprListContext {
    ...
    this.enterRule(_localctx, 132, TSQLParser.RULE_withExprList);
    let _la: number;
    try {
      let _alt: number;
      this.enterOuterAlt(_localctx, 1);
  ...
  public withExpr(): WithExprContext {
    ...
    this.enterRule(_localctx, 134, TSQLParser.RULE_withExpr);
    try {
      this.state = 1185;
      this._errHandler.sync(this);
  ...
  public columnIdentifier(): ColumnIdentifierContext {
    ...
    this.enterRule(_localctx, 136, TSQLParser.RULE_columnIdentifier);
    try {
      this.state = 1194;
      this._errHandler.sync(this);
      switch (this._input.LA(1)) {
  ...
  public nestedIdentifier(): NestedIdentifierContext {
    ...
    this.enterRule(_localctx, 138, TSQLParser.RULE_nestedIdentifier);
    try {
      let _alt: number;
      this.enterOuterAlt(_localctx, 1);
      {
  ...
  public tableExpr(_p?: number): TableExprContext {
    ...
    this.enterRecursionRule(_localctx, 140, TSQLParser.RULE_tableExpr, _p);
    try {
      let _alt: number;
      this.enterOuterAlt(_localctx, 1);
      {
        ...
        while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
          if (_alt === 1) {
            ...
            {
              {
                _localctx = new TableExprAliasContext(
                  new TableExprContext(_parentctx, _parentState)
                );
                this.pushNewRecursionContext(_localctx, _startState, TSQLParser.RULE_tableExpr);
                this.state = 1215;
                if (!this.precpred(this._ctx, 3)) {
                  throw this.createFailedPredicateException("this.precpred(this._ctx, 3)");
                }
  ...
  public tableFunctionExpr(): TableFunctionExprContext {
    ...
    this.enterRule(_localctx, 142, TSQLParser.RULE_tableFunctionExpr);
    let _la: number;
    try {
      this.enterOuterAlt(_localctx, 1);
      {
  ...
  public tableIdentifier(): TableIdentifierContext {
    ...
    this.enterRule(_localctx, 144, TSQLParser.RULE_tableIdentifier);
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        this.state = 1236;
  ...
  public tableArgList(): TableArgListContext {
    ...
    this.enterRule(_localctx, 146, TSQLParser.RULE_tableArgList);
    let _la: number;
    try {
      let _alt: number;
      this.enterOuterAlt(_localctx, 1);
  ...
  public databaseIdentifier(): DatabaseIdentifierContext {
    ...
    this.enterRule(_localctx, 148, TSQLParser.RULE_databaseIdentifier);
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        this.state = 1251;
  ...
  public floatingLiteral(): FloatingLiteralContext {
    ...
    this.enterRule(_localctx, 150, TSQLParser.RULE_floatingLiteral);
    let _la: number;
    try {
      this.state = 1261;
      this._errHandler.sync(this);
      switch (this._input.LA(1)) {
        case TSQLParser.FLOATING_LITERAL:
          ...
          {
            this.state = 1253;
            this.match(TSQLParser.FLOATING_LITERAL);
          }
          break;
        case TSQLParser.DOT:
          this.enterOuterAlt(_localctx, 2);
          {
            ...
            this.state = 1255;
            _la = this._input.LA(1);
            if (!(_la === TSQLParser.OCTAL_LITERAL || _la === TSQLParser.DECIMAL_LITERAL)) {
              this._errHandler.recoverInline(this);
            } else {
              if (this._input.LA(1) === Token.EOF) {
                this.matchedEOF = true;
  ...
  public numberLiteral(): NumberLiteralContext {
    ...
    this.enterRule(_localctx, 152, TSQLParser.RULE_numberLiteral);
    let _la: number;
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        if (_la === TSQLParser.DASH || _la === TSQLParser.PLUS) {
          {
            this.state = 1263;
            _la = this._input.LA(1);
            if (!(_la === TSQLParser.DASH || _la === TSQLParser.PLUS)) {
        ...
        switch (this.interpreter.adaptivePredict(this._input, 162, this._ctx)) {
          ...
          case 2:
            {
              this.state = 1267;
              this.match(TSQLParser.OCTAL_LITERAL);
            }
            break;
          ...
          case 4:
            {
              this.state = 1269;
              this.match(TSQLParser.HEXADECIMAL_LITERAL);
            }
            break;
  ...
  public literal(): LiteralContext {
    ...
    this.enterRule(_localctx, 154, TSQLParser.RULE_literal);
    try {
      this.state = 1277;
      this._errHandler.sync(this);
      switch (this._input.LA(1)) {
  ...
  public interval(): IntervalContext {
    ...
    this.enterRule(_localctx, 156, TSQLParser.RULE_interval);
    let _la: number;
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        ...
        if (
          !(
            ...
            (((_la - 58) & ~0x1f) === 0 &&
              ((1 << (_la - 58)) &
                ((1 << (TSQLParser.MINUTE - 58)) |
                  (1 << (TSQLParser.MONTH - 58)) |
                  (1 << (TSQLParser.QUARTER - 58)) |
                  (1 << (TSQLParser.SECOND - 58)))) !==
                0) ||
            _la === TSQLParser.WEEK ||
            _la === TSQLParser.YEAR
          )
  ...
  public keyword(): KeywordContext {
    ...
    this.enterRule(_localctx, 158, TSQLParser.RULE_keyword);
    let _la: number;
    try {
      this.enterOuterAlt(_localctx, 1);
      {
  ...
  public keywordForAlias(): KeywordForAliasContext {
    ...
    this.enterRule(_localctx, 160, TSQLParser.RULE_keywordForAlias);
    let _la: number;
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        ...
        if (
          !(
            ((_la - 20) & ~0x1f) === 0 &&
            ((1 << (_la - 20)) &
              ((1 << (TSQLParser.DATE - 20)) |
                (1 << (TSQLParser.FIRST - 20)) |
                (1 << (TSQLParser.ID - 20)) |
                (1 << (TSQLParser.KEY - 20)))) !==
              0
          )
  ...
  public alias(): AliasContext {
    ...
    this.enterRule(_localctx, 162, TSQLParser.RULE_alias);
    try {
      this.state = 1287;
      this._errHandler.sync(this);
      switch (this._input.LA(1)) {
  ...
  public identifier(): IdentifierContext {
    ...
    this.enterRule(_localctx, 164, TSQLParser.RULE_identifier);
    try {
      this.state = 1292;
      this._errHandler.sync(this);
      switch (this._input.LA(1)) {
  ...
  public enumValue(): EnumValueContext {
    ...
    this.enterRule(_localctx, 166, TSQLParser.RULE_enumValue);
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        this.state = 1294;
  ...
  public placeholder(): PlaceholderContext {
    ...
    this.enterRule(_localctx, 168, TSQLParser.RULE_placeholder);
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        this.state = 1298;
  ...
  public string(): StringContext {
    ...
    this.enterRule(_localctx, 170, TSQLParser.RULE_string);
    try {
      this.state = 1304;
      this._errHandler.sync(this);
      switch (this._input.LA(1)) {
  ...
  public templateString(): TemplateStringContext {
    ...
    this.enterRule(_localctx, 172, TSQLParser.RULE_templateString);
    let _la: number;
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        this.state = 1306;
        this.match(TSQLParser.QUOTE_SINGLE_TEMPLATE);
        this.state = 1310;
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        while (_la === TSQLParser.STRING_TEXT || _la === TSQLParser.STRING_ESCAPE_TRIGGER) {
          {
            {
              this.state = 1307;
              this.stringContents();
        ...
        this.state = 1313;
        this.match(TSQLParser.QUOTE_SINGLE);
      }
    } catch (re) {
      if (re instanceof RecognitionException) {
        _localctx.exception = re;
  ...
  public stringContents(): StringContentsContext {
    ...
    this.enterRule(_localctx, 174, TSQLParser.RULE_stringContents);
    try {
      this.state = 1320;
      this._errHandler.sync(this);
      switch (this._input.LA(1)) {
        case TSQLParser.STRING_ESCAPE_TRIGGER:
          this.enterOuterAlt(_localctx, 1);
          {
            this.state = 1315;
            this.match(TSQLParser.STRING_ESCAPE_TRIGGER);
            this.state = 1316;
            this.columnExpr(0);
            this.state = 1317;
            this.match(TSQLParser.RBRACE);
          ...
          break;
        case TSQLParser.STRING_TEXT:
          this.enterOuterAlt(_localctx, 2);
          {
            this.state = 1319;
            this.match(TSQLParser.STRING_TEXT);
          }
          break;
        default:
          throw new NoViableAltException(this);
  ...
  public fullTemplateString(): FullTemplateStringContext {
    ...
    this.enterRule(_localctx, 176, TSQLParser.RULE_fullTemplateString);
    let _la: number;
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        this.state = 1322;
        this.match(TSQLParser.QUOTE_SINGLE_TEMPLATE_FULL);
        this.state = 1326;
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        while (
          _la === TSQLParser.FULL_STRING_TEXT ||
          _la === TSQLParser.FULL_STRING_ESCAPE_TRIGGER
        ) {
          {
            {
              this.state = 1323;
  ...
  public stringContentsFull(): StringContentsFullContext {
    ...
    this.enterRule(_localctx, 178, TSQLParser.RULE_stringContentsFull);
    try {
      this.state = 1336;
      this._errHandler.sync(this);
      switch (this._input.LA(1)) {
        case TSQLParser.FULL_STRING_ESCAPE_TRIGGER:
          this.enterOuterAlt(_localctx, 1);
          {
            this.state = 1331;
            this.match(TSQLParser.FULL_STRING_ESCAPE_TRIGGER);
            this.state = 1332;
            this.columnExpr(0);
            this.state = 1333;
            this.match(TSQLParser.RBRACE);
          ...
          break;
        case TSQLParser.FULL_STRING_TEXT:
          this.enterOuterAlt(_localctx, 2);
          {
            this.state = 1335;
            this.match(TSQLParser.FULL_STRING_TEXT);
          }
          break;
        default:
          throw new NoViableAltException(this);
  ...
  public static get _ATN(): ATN {
    if (!TSQLParser.__ATN) {
      TSQLParser.__ATN = new ATNDeserializer().deserialize(
        Utils.toCharArray(TSQLParser._serializedATN)
      );
    }
...
export class ProgramContext extends ParserRuleContext {
  ...
  public get ruleIndex(): number {
    return TSQLParser.RULE_program;
  }
  // @Override
...
export class DeclarationContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_declaration;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class VarDeclContext extends ParserRuleContext {
  public LET(): TerminalNode {
    return this.getToken(TSQLParser.LET, 0);
  }
  public identifier(): IdentifierContext {
    return this.getRuleContext(0, IdentifierContext);
  }
  public COLON(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.COLON, 0);
  }
  public EQ_SINGLE(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.EQ_SINGLE, 0);
  }
  ...
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_varDecl;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class IdentifierListContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_identifierList;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class StatementContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_statement;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class ReturnStmtContext extends ParserRuleContext {
  ...
  public SEMICOLON(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.SEMICOLON, 0);
  }
  constructor(parent: ParserRuleContext | undefined, invokingState: number) {
    super(parent, invokingState);
  }
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_returnStmt;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class ThrowStmtContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_throwStmt;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class CatchBlockContext extends ParserRuleContext {
  ...
  public LPAREN(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.LPAREN, 0);
  }
  public RPAREN(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.RPAREN, 0);
  }
  public identifier(): IdentifierContext[];
  public identifier(i: number): IdentifierContext;
  public identifier(i?: number): IdentifierContext | IdentifierContext[] {
  ...
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_catchBlock;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class TryCatchStmtContext extends ParserRuleContext {
  ...
  public FINALLY(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.FINALLY, 0);
  }
  constructor(parent: ParserRuleContext | undefined, invokingState: number) {
    super(parent, invokingState);
  }
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_tryCatchStmt;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class IfStmtContext extends ParserRuleContext {
  ...
  public LPAREN(): TerminalNode {
    return this.getToken(TSQLParser.LPAREN, 0);
  }
  public expression(): ExpressionContext {
    return this.getRuleContext(0, ExpressionContext);
  }
  public RPAREN(): TerminalNode {
    return this.getToken(TSQLParser.RPAREN, 0);
  }
  public statement(): StatementContext[];
  ...
  public ELSE(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.ELSE, 0);
  }
  constructor(parent: ParserRuleContext | undefined, invokingState: number) {
    super(parent, invokingState);
  }
...
export class WhileStmtContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_whileStmt;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class ForStmtContext extends ParserRuleContext {
  ...
  public SEMICOLON(i?: number): TerminalNode | TerminalNode[] {
    if (i === undefined) {
      return this.getTokens(TSQLParser.SEMICOLON);
    } else {
      return this.getToken(TSQLParser.SEMICOLON, i);
    }
  }
  public RPAREN(): TerminalNode {
    return this.getToken(TSQLParser.RPAREN, 0);
  ...
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_forStmt;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class ForInStmtContext extends ParserRuleContext {
  ...
  public COMMA(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.COMMA, 0);
  }
  public SEMICOLON(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.SEMICOLON, 0);
  }
...
export class FuncStmtContext extends ParserRuleContext {
  ...
  public FN(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.FN, 0);
  }
  public FUN(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.FUN, 0);
  }
  ...
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_funcStmt;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class VarAssignmentContext extends ParserRuleContext {
  ...
  public EQ_SINGLE(): TerminalNode {
    return this.getToken(TSQLParser.EQ_SINGLE, 0);
  }
  constructor(parent: ParserRuleContext | undefined, invokingState: number) {
    super(parent, invokingState);
  }
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_varAssignment;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class ExprStmtContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_exprStmt;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class EmptyStmtContext extends ParserRuleContext {
  public SEMICOLON(): TerminalNode {
    return this.getToken(TSQLParser.SEMICOLON, 0);
  }
  constructor(parent: ParserRuleContext | undefined, invokingState: number) {
    super(parent, invokingState);
  }
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_emptyStmt;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class BlockContext extends ParserRuleContext {
  public LBRACE(): TerminalNode {
    return this.getToken(TSQLParser.LBRACE, 0);
  }
  public RBRACE(): TerminalNode {
    return this.getToken(TSQLParser.RBRACE, 0);
  }
  public declaration(): DeclarationContext[];
  public declaration(i: number): DeclarationContext;
  public declaration(i?: number): DeclarationContext | DeclarationContext[] {
...
export class KvPairListContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_kvPairList;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class SelectContext extends ParserRuleContext {
  ...
  public tSQLxTagElement(): TSQLxTagElementContext | undefined {
    return this.tryGetRuleContext(0, TSQLxTagElementContext);
  }
  public SEMICOLON(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.SEMICOLON, 0);
  }
...
export class SubsequentSelectSetClauseContext extends ParserRuleContext {
  ...
  public EXCEPT(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.EXCEPT, 0);
  }
  public UNION(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.UNION, 0);
  }
  public ALL(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.ALL, 0);
  }
  public DISTINCT(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.DISTINCT, 0);
  }
  public INTERSECT(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.INTERSECT, 0);
  }
  constructor(parent: ParserRuleContext | undefined, invokingState: number) {
    super(parent, invokingState);
  }
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_subsequentSelectSetClause;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class SelectSetStmtContext extends ParserRuleContext {
  ...
  public subsequentSelectSetClause(
    i?: number
  ): SubsequentSelectSetClauseContext | SubsequentSelectSetClauseContext[] {
    if (i === undefined) {
  ...
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_selectSetStmt;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class SelectStmtContext extends ParserRuleContext {
  ...
  public TOTALS(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.TOTALS, 0);
  }
  ...
  public CUBE(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.CUBE, 0);
  }
  public ROLLUP(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.ROLLUP, 0);
  }
  constructor(parent: ParserRuleContext | undefined, invokingState: number) {
    super(parent, invokingState);
  }
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_selectStmt;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class WithClauseContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_withClause;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class TopClauseContext extends ParserRuleContext {
  ...
  public DECIMAL_LITERAL(): TerminalNode {
    return this.getToken(TSQLParser.DECIMAL_LITERAL, 0);
  }
  public WITH(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.WITH, 0);
  }
  public TIES(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.TIES, 0);
  }
  constructor(parent: ParserRuleContext | undefined, invokingState: number) {
    super(parent, invokingState);
  }
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_topClause;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class FromClauseContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_fromClause;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class ArrayJoinClauseContext extends ParserRuleContext {
  public ARRAY(): TerminalNode {
    return this.getToken(TSQLParser.ARRAY, 0);
  }
  ...
  public LEFT(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.LEFT, 0);
  }
  public INNER(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.INNER, 0);
  }
  constructor(parent: ParserRuleContext | undefined, invokingState: number) {
    super(parent, invokingState);
  }
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_arrayJoinClause;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class WindowClauseContext extends ParserRuleContext {
  public WINDOW(): TerminalNode {
    return this.getToken(TSQLParser.WINDOW, 0);
  }
  public identifier(): IdentifierContext[];
  public identifier(i: number): IdentifierContext;
  public identifier(i?: number): IdentifierContext | IdentifierContext[] {
  ...
  public AS(i?: number): TerminalNode | TerminalNode[] {
    if (i === undefined) {
      return this.getTokens(TSQLParser.AS);
    } else {
      return this.getToken(TSQLParser.AS, i);
    }
  }
  public LPAREN(): TerminalNode[];
  ...
  public LPAREN(i?: number): TerminalNode | TerminalNode[] {
    if (i === undefined) {
      return this.getTokens(TSQLParser.LPAREN);
    } else {
      return this.getToken(TSQLParser.LPAREN, i);
    }
  }
  public windowExpr(): WindowExprContext[];
  ...
  public RPAREN(i?: number): TerminalNode | TerminalNode[] {
    if (i === undefined) {
      return this.getTokens(TSQLParser.RPAREN);
    } else {
      return this.getToken(TSQLParser.RPAREN, i);
    }
  }
  public COMMA(): TerminalNode[];
  public COMMA(i: number): TerminalNode;
  ...
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_windowClause;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class PrewhereClauseContext extends ParserRuleContext {
  public PREWHERE(): TerminalNode {
    return this.getToken(TSQLParser.PREWHERE, 0);
  }
  public columnExpr(): ColumnExprContext {
    return this.getRuleContext(0, ColumnExprContext);
  }
...
export class GroupByClauseContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_groupByClause;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class HavingClauseContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_havingClause;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class OrderByClauseContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_orderByClause;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class ProjectionOrderByClauseContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_projectionOrderByClause;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class LimitByClauseContext extends ParserRuleContext {
  public LIMIT(): TerminalNode {
    return this.getToken(TSQLParser.LIMIT, 0);
  }
  public limitExpr(): LimitExprContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_limitByClause;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class LimitAndOffsetClauseContext extends ParserRuleContext {
  ...
  public OFFSET(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.OFFSET, 0);
  }
  constructor(parent: ParserRuleContext | undefined, invokingState: number) {
    super(parent, invokingState);
  }
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_limitAndOffsetClause;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class SettingsClauseContext extends ParserRuleContext {
  public SETTINGS(): TerminalNode {
    return this.getToken(TSQLParser.SETTINGS, 0);
  }
  public settingExprList(): SettingExprListContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_settingsClause;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class JoinExprContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_joinExpr;
  }
...
export class JoinExprTableContext extends JoinExprContext {
  ...
  public FINAL(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.FINAL, 0);
  }
...
export class JoinOpInnerContext extends JoinOpContext {
  ...
  public ANY(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.ANY, 0);
  }
  public ASOF(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.ASOF, 0);
  }
...
export class JoinOpLeftRightContext extends JoinOpContext {
  ...
  public RIGHT(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.RIGHT, 0);
  }
  public OUTER(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.OUTER, 0);
  }
  public SEMI(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.SEMI, 0);
  }
  public ALL(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.ALL, 0);
  }
  public ANTI(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.ANTI, 0);
  }
  public ANY(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.ANY, 0);
  }
...
export class JoinOpFullContext extends JoinOpContext {
  public FULL(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.FULL, 0);
  }
  public OUTER(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.OUTER, 0);
  }
...
export class JoinOpCrossContext extends ParserRuleContext {
  public CROSS(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.CROSS, 0);
  }
  public JOIN(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.JOIN, 0);
  }
  public COMMA(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.COMMA, 0);
  }
  ...
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_joinOpCross;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class JoinConstraintClauseContext extends ParserRuleContext {
  public ON(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.ON, 0);
  }
  public columnExprList(): ColumnExprListContext {
    return this.getRuleContext(0, ColumnExprListContext);
  }
  public USING(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.USING, 0);
  }
  public LPAREN(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.LPAREN, 0);
  }
  ...
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_joinConstraintClause;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class SampleClauseContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_sampleClause;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class LimitExprContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_limitExpr;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class OrderExprListContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_orderExprList;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class OrderExprContext extends ParserRuleContext {
  ...
  public NULLS(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.NULLS, 0);
  }
  public COLLATE(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.COLLATE, 0);
  }
  public STRING_LITERAL(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.STRING_LITERAL, 0);
  }
  public ASCENDING(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.ASCENDING, 0);
  }
  public DESCENDING(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.DESCENDING, 0);
  }
  public DESC(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.DESC, 0);
  }
  public FIRST(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.FIRST, 0);
  }
  public LAST(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.LAST, 0);
  }
  constructor(parent: ParserRuleContext | undefined, invokingState: number) {
    super(parent, invokingState);
  }
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_orderExpr;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class RatioExprContext extends ParserRuleContext {
  ...
  public SLASH(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.SLASH, 0);
  }
  constructor(parent: ParserRuleContext | undefined, invokingState: number) {
    super(parent, invokingState);
  }
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_ratioExpr;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class SettingExprListContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_settingExprList;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class SettingExprContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_settingExpr;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class WindowExprContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_windowExpr;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class WinPartitionByClauseContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_winPartitionByClause;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class WinOrderByClauseContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_winOrderByClause;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class WinFrameClauseContext extends ParserRuleContext {
  ...
  public ROWS(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.ROWS, 0);
  }
  public RANGE(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.RANGE, 0);
  }
  constructor(parent: ParserRuleContext | undefined, invokingState: number) {
    super(parent, invokingState);
  }
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_winFrameClause;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class WinFrameExtendContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_winFrameExtend;
  }
...
export class WinFrameBoundContext extends ParserRuleContext {
  public CURRENT(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.CURRENT, 0);
  }
  public ROW(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.ROW, 0);
  }
  public UNBOUNDED(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.UNBOUNDED, 0);
  }
  public PRECEDING(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.PRECEDING, 0);
  }
  public FOLLOWING(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.FOLLOWING, 0);
  }
...
export class ColumnTypeExprContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_columnTypeExpr;
  }
...
export class ColumnExprListContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_columnExprList;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class ColumnExprContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_columnExpr;
  }
...
export class ColumnExprDateContext extends ColumnExprContext {
  ...
  public STRING_LITERAL(): TerminalNode {
    return this.getToken(TSQLParser.STRING_LITERAL, 0);
  }
  constructor(ctx: ColumnExprContext) {
    super(ctx.parent, ctx.invokingState);
    this.copyFrom(ctx);
...
export class ColumnExprIntervalStringContext extends ColumnExprContext {
  public INTERVAL(): TerminalNode {
    return this.getToken(TSQLParser.INTERVAL, 0);
  }
  public STRING_LITERAL(): TerminalNode {
    return this.getToken(TSQLParser.STRING_LITERAL, 0);
  }
...
export class ColumnExprSubstringContext extends ColumnExprContext {
  public SUBSTRING(): TerminalNode {
    return this.getToken(TSQLParser.SUBSTRING, 0);
  }
  public LPAREN(): TerminalNode {
    return this.getToken(TSQLParser.LPAREN, 0);
  }
  ...
  public FOR(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.FOR, 0);
  }
  constructor(ctx: ColumnExprContext) {
    super(ctx.parent, ctx.invokingState);
    this.copyFrom(ctx);
...
export class ColumnExprTrimContext extends ColumnExprContext {
  public TRIM(): TerminalNode {
    return this.getToken(TSQLParser.TRIM, 0);
  }
  public LPAREN(): TerminalNode {
    return this.getToken(TSQLParser.LPAREN, 0);
  }
  ...
  public BOTH(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.BOTH, 0);
  }
  public LEADING(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.LEADING, 0);
  }
  public TRAILING(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.TRAILING, 0);
  }
  constructor(ctx: ColumnExprContext) {
    super(ctx.parent, ctx.invokingState);
    this.copyFrom(ctx);
...
export class ColumnExprTagElementContext extends ColumnExprContext {
  public tSQLxTagElement(): TSQLxTagElementContext {
    return this.getRuleContext(0, TSQLxTagElementContext);
  }
  constructor(ctx: ColumnExprContext) {
    super(ctx.parent, ctx.invokingState);
    this.copyFrom(ctx);
...
export class ColumnExprArrayAccessContext extends ColumnExprContext {
  ...
  public LBRACKET(): TerminalNode {
    return this.getToken(TSQLParser.LBRACKET, 0);
  }
  public RBRACKET(): TerminalNode {
    return this.getToken(TSQLParser.RBRACKET, 0);
  }
  constructor(ctx: ColumnExprContext) {
    super(ctx.parent, ctx.invokingState);
    this.copyFrom(ctx);
...
export class ColumnExprNullArrayAccessContext extends ColumnExprContext {
  ...
  public NULL_PROPERTY(): TerminalNode {
    return this.getToken(TSQLParser.NULL_PROPERTY, 0);
  }
  public LBRACKET(): TerminalNode {
    return this.getToken(TSQLParser.LBRACKET, 0);
  }
...
export class ColumnExprNegateContext extends ColumnExprContext {
  public DASH(): TerminalNode {
    return this.getToken(TSQLParser.DASH, 0);
  }
  public columnExpr(): ColumnExprContext {
    return this.getRuleContext(0, ColumnExprContext);
  }
...
export class ColumnExprPrecedence1Context extends ColumnExprContext {
  ...
  public ASTERISK(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.ASTERISK, 0);
  }
  public SLASH(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.SLASH, 0);
  }
  public PERCENT(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.PERCENT, 0);
  }
  constructor(ctx: ColumnExprContext) {
    super(ctx.parent, ctx.invokingState);
    this.copyFrom(ctx);
...
export class ColumnExprPrecedence2Context extends ColumnExprContext {
  ...
  public PLUS(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.PLUS, 0);
  }
  public DASH(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.DASH, 0);
  }
  public CONCAT(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.CONCAT, 0);
  }
  constructor(ctx: ColumnExprContext) {
    super(ctx.parent, ctx.invokingState);
    this.copyFrom(ctx);
...
export class ColumnExprPrecedence3Context extends ColumnExprContext {
  ...
  public IN(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.IN, 0);
  }
  public EQ_DOUBLE(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.EQ_DOUBLE, 0);
  }
  public EQ_SINGLE(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.EQ_SINGLE, 0);
  }
  public NOT_EQ(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.NOT_EQ, 0);
  }
  public LT_EQ(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.LT_EQ, 0);
  }
  public LT(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.LT, 0);
  }
  public GT_EQ(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.GT_EQ, 0);
  }
  public GT(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.GT, 0);
  }
  public LIKE(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.LIKE, 0);
  }
  public ILIKE(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.ILIKE, 0);
  }
  public REGEX_SINGLE(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.REGEX_SINGLE, 0);
  }
  public REGEX_DOUBLE(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.REGEX_DOUBLE, 0);
  }
  public NOT_REGEX(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.NOT_REGEX, 0);
  }
  public IREGEX_SINGLE(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.IREGEX_SINGLE, 0);
  }
  public IREGEX_DOUBLE(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.IREGEX_DOUBLE, 0);
  }
  public NOT_IREGEX(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.NOT_IREGEX, 0);
  }
  public COHORT(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.COHORT, 0);
  }
  public NOT(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.NOT, 0);
  }
  constructor(ctx: ColumnExprContext) {
    super(ctx.parent, ctx.invokingState);
    this.copyFrom(ctx);
...
export class ColumnExprIsNullContext extends ColumnExprContext {
  ...
  public NULL_SQL(): TerminalNode {
    return this.getToken(TSQLParser.NULL_SQL, 0);
  }
  public NOT(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.NOT, 0);
  }
...
export class ColumnExprNullishContext extends ColumnExprContext {
  ...
  public NULLISH(): TerminalNode {
    return this.getToken(TSQLParser.NULLISH, 0);
  }
  constructor(ctx: ColumnExprContext) {
    super(ctx.parent, ctx.invokingState);
    this.copyFrom(ctx);
...
export class ColumnExprAliasContext extends ColumnExprContext {
  ...
  public AS(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.AS, 0);
  }
...
export class ColumnExprAsteriskContext extends ColumnExprContext {
  public ASTERISK(): TerminalNode {
    return this.getToken(TSQLParser.ASTERISK, 0);
  }
  ...
  public DOT(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.DOT, 0);
  }
  constructor(ctx: ColumnExprContext) {
    super(ctx.parent, ctx.invokingState);
    this.copyFrom(ctx);
...
export class ColumnLambdaExprContext extends ParserRuleContext {
  public ARROW(): TerminalNode {
    return this.getToken(TSQLParser.ARROW, 0);
  }
  public LPAREN(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.LPAREN, 0);
  }
  ...
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_columnLambdaExpr;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class TSQLxChildElementContext extends ParserRuleContext {
  public tSQLxTagElement(): TSQLxTagElementContext | undefined {
    return this.tryGetRuleContext(0, TSQLxTagElementContext);
  }
  public TSQLX_TEXT_TEXT(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.TSQLX_TEXT_TEXT, 0);
  }
  public LBRACE(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.LBRACE, 0);
  }
  public columnExpr(): ColumnExprContext | undefined {
    return this.tryGetRuleContext(0, ColumnExprContext);
  }
  public RBRACE(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.RBRACE, 0);
  }
  constructor(parent: ParserRuleContext | undefined, invokingState: number) {
    super(parent, invokingState);
  }
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_tSQLxChildElement;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
    if (visitor.visitTSQLxChildElement) {
      return visitor.visitTSQLxChildElement(this);
    } else {
      return visitor.visitChildren(this);
    }
  }
...
export class TSQLxTagElementContext extends ParserRuleContext {
  ...
  public SLASH_GT(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.SLASH_GT, 0);
  }
  public tSQLxTagAttribute(): TSQLxTagAttributeContext[];
  public tSQLxTagAttribute(i: number): TSQLxTagAttributeContext;
  public tSQLxTagAttribute(i?: number): TSQLxTagAttributeContext | TSQLxTagAttributeContext[] {
    if (i === undefined) {
      return this.getRuleContexts(TSQLxTagAttributeContext);
    } else {
      return this.getRuleContext(i, TSQLxTagAttributeContext);
    }
  }
  ...
  public GT(i?: number): TerminalNode | TerminalNode[] {
    if (i === undefined) {
      return this.getTokens(TSQLParser.GT);
    } else {
      return this.getToken(TSQLParser.GT, i);
    }
  }
  public LT_SLASH(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.LT_SLASH, 0);
  }
  public tSQLxChildElement(): TSQLxChildElementContext[];
  public tSQLxChildElement(i: number): TSQLxChildElementContext;
  public tSQLxChildElement(i?: number): TSQLxChildElementContext | TSQLxChildElementContext[] {
    if (i === undefined) {
      return this.getRuleContexts(TSQLxChildElementContext);
    } else {
      return this.getRuleContext(i, TSQLxChildElementContext);
    }
  }
  constructor(parent: ParserRuleContext | undefined, invokingState: number) {
    super(parent, invokingState);
  ...
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_tSQLxTagElement;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
    if (visitor.visitTSQLxTagElement) {
      return visitor.visitTSQLxTagElement(this);
    } else {
      return visitor.visitChildren(this);
    }
  }
...
export class TSQLxTagAttributeContext extends ParserRuleContext {
  public identifier(): IdentifierContext {
    return this.getRuleContext(0, IdentifierContext);
  }
  public EQ_SINGLE(): TerminalNode | undefined {
  ...
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_tSQLxTagAttribute;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
    if (visitor.visitTSQLxTagAttribute) {
      return visitor.visitTSQLxTagAttribute(this);
    } else {
      return visitor.visitChildren(this);
    }
  }
...
export class WithExprListContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_withExprList;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class WithExprContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_withExpr;
  }
...
export class ColumnIdentifierContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_columnIdentifier;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class NestedIdentifierContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_nestedIdentifier;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class TableExprContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_tableExpr;
  }
...
export class TableIdentifierContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_tableIdentifier;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class TableArgListContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_tableArgList;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class DatabaseIdentifierContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_databaseIdentifier;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class FloatingLiteralContext extends ParserRuleContext {
  public FLOATING_LITERAL(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.FLOATING_LITERAL, 0);
  }
  public DOT(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.DOT, 0);
  }
  ...
  public DECIMAL_LITERAL(i?: number): TerminalNode | TerminalNode[] {
    if (i === undefined) {
      return this.getTokens(TSQLParser.DECIMAL_LITERAL);
    } else {
      return this.getToken(TSQLParser.DECIMAL_LITERAL, i);
    }
  }
  public OCTAL_LITERAL(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.OCTAL_LITERAL, 0);
  }
  constructor(parent: ParserRuleContext | undefined, invokingState: number) {
    super(parent, invokingState);
  }
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_floatingLiteral;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class NumberLiteralContext extends ParserRuleContext {
  ...
  public DECIMAL_LITERAL(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.DECIMAL_LITERAL, 0);
  }
  public HEXADECIMAL_LITERAL(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.HEXADECIMAL_LITERAL, 0);
  }
  public INF(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.INF, 0);
  }
  public NAN_SQL(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.NAN_SQL, 0);
  }
  public PLUS(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.PLUS, 0);
  }
  ...
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_numberLiteral;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class LiteralContext extends ParserRuleContext {
  ...
  public NULL_SQL(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.NULL_SQL, 0);
  }
  constructor(parent: ParserRuleContext | undefined, invokingState: number) {
    super(parent, invokingState);
  }
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_literal;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class IntervalContext extends ParserRuleContext {
  public SECOND(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.SECOND, 0);
  }
  public MINUTE(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.MINUTE, 0);
  }
  public HOUR(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.HOUR, 0);
  }
  public DAY(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.DAY, 0);
  }
  public WEEK(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.WEEK, 0);
  }
  public MONTH(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.MONTH, 0);
  }
  public QUARTER(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.QUARTER, 0);
  }
  public YEAR(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.YEAR, 0);
  }
  constructor(parent: ParserRuleContext | undefined, invokingState: number) {
    super(parent, invokingState);
  }
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_interval;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class KeywordContext extends ParserRuleContext {
  ...
  public AND(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.AND, 0);
  }
  public ANTI(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.ANTI, 0);
  }
  ...
  public ARRAY(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.ARRAY, 0);
  }
  public AS(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.AS, 0);
  }
  ...
  public BETWEEN(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.BETWEEN, 0);
  }
  public BOTH(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.BOTH, 0);
  }
  public BY(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.BY, 0);
  }
  public CASE(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.CASE, 0);
  }
  public CAST(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.CAST, 0);
  }
  public COHORT(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.COHORT, 0);
  }
  ...
  public DATE(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.DATE, 0);
  }
  public DESC(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.DESC, 0);
  }
  ...
  public END(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.END, 0);
  }
  public EXTRACT(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.EXTRACT, 0);
  }
  public FINAL(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.FINAL, 0);
  }
  ...
  public FROM(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.FROM, 0);
  }
  public FULL(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.FULL, 0);
  }
  public GROUP(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.GROUP, 0);
  }
  public HAVING(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.HAVING, 0);
  }
  public ID(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.ID, 0);
  }
  public IS(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.IS, 0);
  }
  public IF(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.IF, 0);
  }
  public ILIKE(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.ILIKE, 0);
  }
  ...
  public INTERVAL(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.INTERVAL, 0);
  }
  public JOIN(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.JOIN, 0);
  }
  public KEY(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.KEY, 0);
  }
  public LAST(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.LAST, 0);
  }
  ...
  public LIMIT(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.LIMIT, 0);
  }
  public NOT(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.NOT, 0);
  }
  ...
  public OR(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.OR, 0);
  }
  public ORDER(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.ORDER, 0);
  }
  public OUTER(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.OUTER, 0);
  }
  public OVER(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.OVER, 0);
  }
  public PARTITION(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.PARTITION, 0);
  }
  public PRECEDING(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.PRECEDING, 0);
  }
  public PREWHERE(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.PREWHERE, 0);
  }
  public RANGE(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.RANGE, 0);
  }
  public RETURN(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.RETURN, 0);
  }
  public RIGHT(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.RIGHT, 0);
  }
  ...
  public SAMPLE(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.SAMPLE, 0);
  }
  public SELECT(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.SELECT, 0);
  }
  public SEMI(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.SEMI, 0);
  }
  public SETTINGS(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.SETTINGS, 0);
  }
  public SUBSTRING(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.SUBSTRING, 0);
  }
  public THEN(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.THEN, 0);
  }
  public TIES(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.TIES, 0);
  }
  public TIMESTAMP(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.TIMESTAMP, 0);
  }
  public TOTALS(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.TOTALS, 0);
  }
  ...
  public TRIM(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.TRIM, 0);
  }
  public TRUNCATE(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.TRUNCATE, 0);
  }
  public TO(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.TO, 0);
  }
  public TOP(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.TOP, 0);
  }
  public UNBOUNDED(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.UNBOUNDED, 0);
  }
  ...
  public WHEN(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.WHEN, 0);
  }
  public WHERE(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.WHERE, 0);
  }
  public WINDOW(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.WINDOW, 0);
  }
  public WITH(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.WITH, 0);
  }
...
export class KeywordForAliasContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_keywordForAlias;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class AliasContext extends ParserRuleContext {
  public IDENTIFIER(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.IDENTIFIER, 0);
  }
...
export class EnumValueContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_enumValue;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class PlaceholderContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_placeholder;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class TemplateStringContext extends ParserRuleContext {
  public QUOTE_SINGLE_TEMPLATE(): TerminalNode {
    return this.getToken(TSQLParser.QUOTE_SINGLE_TEMPLATE, 0);
  }
  public QUOTE_SINGLE(): TerminalNode {
    return this.getToken(TSQLParser.QUOTE_SINGLE, 0);
  }
  public stringContents(): StringContentsContext[];
...
export class StringContentsContext extends ParserRuleContext {
  public STRING_ESCAPE_TRIGGER(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.STRING_ESCAPE_TRIGGER, 0);
  }
  public columnExpr(): ColumnExprContext | undefined {
    return this.tryGetRuleContext(0, ColumnExprContext);
  }
  ...
  public STRING_TEXT(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.STRING_TEXT, 0);
  }
  constructor(parent: ParserRuleContext | undefined, invokingState: number) {
    super(parent, invokingState);
  }
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_stringContents;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class FullTemplateStringContext extends ParserRuleContext {
  public QUOTE_SINGLE_TEMPLATE_FULL(): TerminalNode {
    return this.getToken(TSQLParser.QUOTE_SINGLE_TEMPLATE_FULL, 0);
  }
  public EOF(): TerminalNode {
    return this.getToken(TSQLParser.EOF, 0);
  }
  ...
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_fullTemplateString;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
...
export class StringContentsFullContext extends ParserRuleContext {
  public FULL_STRING_ESCAPE_TRIGGER(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.FULL_STRING_ESCAPE_TRIGGER, 0);
  }
  public columnExpr(): ColumnExprContext | undefined {
    return this.tryGetRuleContext(0, ColumnExprContext);
  }
  ...
  public FULL_STRING_TEXT(): TerminalNode | undefined {
    return this.tryGetToken(TSQLParser.FULL_STRING_TEXT, 0);
  }
  constructor(parent: ParserRuleContext | undefined, invokingState: number) {
    super(parent, invokingState);
  }
  // @Override
  public get ruleIndex(): number {
    return TSQLParser.RULE_stringContentsFull;
  }
  // @Override
  public accept<Result>(visitor: TSQLParserVisitor<Result>): Result {
